...
# only used for doing simulation and plots
...
def Hx(x, landmark_pos):
    """ takes a state variable and returns the measurement
        ...
        """
    camera_offset = 0    # no offset in this simulation
    direction = x[2,0]
    px = landmark_pos[0] + cos(direction)*camera_offset
    py = landmark_pos[1] + sin(direction)*camera_offset
...
def run_localization(landmarks, std_vel, std_steer,
                     ...
                     step=10, ellipse_step=20, ylim=None, dt=1.0):
